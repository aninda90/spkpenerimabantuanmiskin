...
<head>
    ...
    <title>SPK Siswa Penerima Bantuan Miskin - Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?page=dashboard">
                <div class="sidebar-brand-icon p-2">
                    ...
                    <img src="assets/img/logo.png" alt="" class="img-profile w-100">
                </div>
                <div class="sidebar-brand-text mx-2 text-left font-weight-bold">SPK Siswa Bantuan</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>SPK Siswa Penerima Bantuan Miskin - 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
