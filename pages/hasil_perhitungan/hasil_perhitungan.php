...
<?php  
  ...
  } else if (@$_GET['hasil'] == 'perangkingan') {
    $activ1 = '';
    $activ2 = '';
    $activ3 = '';
    $activ4 = 'active';
...
<nav aria-label="...">
  <ul class="pagination pagination-md flex-wrap flex-md-nowrap">
    ...
    <li class="page-item w-100 <?= $activ2 ?>">
    	<a class="page-link rounded-0 <?= $text2 ?>" href="index.php?page=hasil_perhitungan&hasil=optimasi" style="color: grey;">Hasil Optimasi</a>
    </li>
    <li class="page-item w-100 <?= $activ3 ?>">
    	<a class="page-link rounded-0 <?= $text3 ?>" href="index.php?page=hasil_perhitungan&hasil=akhir" style="color: grey;">Nilai Akhir</a>
    </li>
    <li class="page-item w-100 <?= $activ4 ?>">
    	<a class="page-link rounded-0 <?= $text4 ?>" href="index.php?page=hasil_perhitungan&hasil=perankingan" style="color: grey;">Perankingan</a>
    </li>
  </ul>
</nav>
