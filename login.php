...
<head>
    ...
    <title>SPK Siswa Penerima Bantuan Miskin - Login</title>
                            ...
                            <div class="col-lg-6 d-none d-lg-flex bg-login-image align-items-center justify-content-center">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-8 d-flex align-items-center p-0">
                                      <h5 class="text-white text-uppercase"><span>Sistem Penunjang Keputusan</span><br>Penerima Bantuan Miskin</h5>  
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5">
                                    <div class="text-center">
                                        <img src="assets/img/logo.png" alt="logo" title="logo" class="logo d-lg-none mb-2">
                                        <h5 class="text-gray-800 text-uppercase mb-4 d-lg-none"><span>SPK</span><br>Penerima Bantuan Miskin</h5>
                                        <p class="h6 text-gray-800 mb-4 d-lg-none">Admin Login</p>
                                        <p class="h5 text-gray-800 mb-4 d-lg-block d-none">Admin Login</p>
                                        <!-- <img src="assets/img/logo.png" alt="" class="img-profile w-25"> -->
                                    </div>
